...
class Trivia(commands.Cog):
    ...
    {"lyric": "Pop a Xan and pop a tag, backstage pass, we in the back", "song": "Bloody Mary"},
    ...
    {"lyric": "Hop outside the limousine in the backseat of the cab", "song": "Bloody Mary"},
    ...
    {"lyric": "We're moving in slow-mo, like a movie", "song": "Wicker man"},
    ...
    {"lyric": "Hop out the limousine, free Britney, I'm off Xanax like it's 2017", "song": "Bloody Mary"},
    ...
    {"lyric": "I don't fuck with candy corn, put me in a fuckin' porn", "song": "Bloody Mary"},
    ...
    {"lyric": "Why they gay? Why they on my dick?", "song": "Bloody Mary"},
    {"lyric": "I just killed my ex today", "song": "Murder in hollywood"},
    {"lyric": "You're not my friend so don't act like it", "song": "Haunted house"},
    ...
    {"lyric": "I'm at the pumpkin patch, where's Punkin at?", "song": "Bloody Mary"},
    ...
    {"lyric": "I got bloody racks on me, I'm off dirty drugs", "song": "Bloody Mary"},
    {"lyric": "Pop a Xan' and fall asleep, honestly, we're meant to", "song": "Bloody Mary"},
    {"lyric": "Thirty racks all on my jeans, I'm off the lean inside the jeep", "song": "Bloody Mary"},
    ...
    {"lyric": "I'm flexing hard, I'll never stop", "song": "Black amiri uggs"},
    {"lyric": "Tie me to the train tracks, yeah, I really love that", "song": "Fuck ur clique"},
    {"lyric": "Let's hit the bar, they don't card", "song": "Black amiri yggs"},
    {"lyric": "I got no presents on Christmas", "song": "Black amiri Uggs"},
    {"lyric": "Six ninety on my shoes, what do I have to lose?", "song": "Black amiri yggs"},
    {"lyric": "Cookies on my plate, I'm in love with these candy canes", "song": "Prada"},
    ...
    @app_commands.command(name="nick6383trivia", description="Guess which song the lyric is from.")
    async def trivia(self, interaction: discord.Interaction):
        ...
        while len(options) < 4:
            random_title = random.choice(self.all_titles)
            if random_title not in options:
                options.append(random_title)
        ...
        embed.set_thumbnail(url="attachment://server_icon.jpg")  # <-- Set your server icon image here

        view = TriviaView(interaction.user, correct_song, options)
        await interaction.response.send_message(embed=embed, view=view, file=discord.File("mxJrBrTE_400x400.jpg", filename="server_icon.jpg"))
...
class TriviaButton(discord.ui.Button):
    def __init__(self, label, view: TriviaView):
    ...
    async def callback(self, interaction: discord.Interaction):
        if interaction.user != self.user:
            await interaction.response.send_message("Only the original player can answer this trivia.", ephemeral=True)
            return
